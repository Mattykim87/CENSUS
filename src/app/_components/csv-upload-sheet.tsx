...
import { csvUploadSchema, type CSVUploadSchema } from "../_lib/validations";
...
export function CSVUploadSheet({ children }: CSVUploadSheetProps) {
  ...
  const handlePreviewConfirm = (file: File, headers: string[], rowCount: number) => {
    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            Upload a CSV file to create tasks
          </SheetDescription>
        </SheetHeader>
        <div className="mt-6">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-2">
                <CSVPreviewSheet 
                  onConfirm={(file, headers, rowCount) => handlePreviewConfirm(file, headers, rowCount)}
                >
